	...
	<body>
		...
		<div class="container mycontent">
			...
			<div class="inputDiv">
				<p>请选择要浏览的页面</p>
				<ul>
					<li><a class="btn btn-sm btn-info" href="web/index.jsp">网站首页</a></li>
					<li><a class="btn btn-sm btn-info" href="web/login.jsp">登录页面</a></li>
					<li><a class="btn btn-sm btn-info" href="web/register.jsp">注册页面 </a></li>
