			...
			<div class="row">
				...
				<div class="col-md-9 top-item">
					<ul class="list-inline pull-right">
						...
						<li class="li-split">|</li>
						<li><a href="#"><span class="fa fa-cart-plus"></span>&nbsp;购物车</a></li>
						<li class="li-split">|</li>
						<li>
							<!--下列列表按钮 ：管理-->
							<div class="btn-group">
			...
			<div class="col-md-offset-1 col-md-10">
				<div class="col-md-6">
					...
					<div data="1" class="img-big move-img col-md-12">
						<img id="product-image-1-big" src="${pageContext.request.contextPath}${product.image}1_big.png" class="img-responsive" />
					</div>
					<div data="2" class="img-big move-img col-md-12">
						<img id="product-image-2-big" src="${pageContext.request.contextPath}${product.image}2_big.png" class="img-responsive" />
					</div>
					<div data="3" class="img-big move-img col-md-12">
						<img id="product-image-3-big" src="${pageContext.request.contextPath}${product.image}3_big.png" class="img-responsive" />
					</div>
					<div data="4" class="img-big move-img col-md-12">
						<img id="product-image-4-big" src="${pageContext.request.contextPath}${product.image}4_big.png" class="img-responsive" />
					</div>
					<div data="5" class="img-big move-img col-md-12">
						<img id="product-image-5-big" src="${pageContext.request.contextPath}${product.image}5_big.png" class="img-responsive" />
					</div>
					<div data="1" class="col-md-2 img-small">
						<img id="product-image-1" src="${pageContext.request.contextPath}${product.image}1.jpg" class="img-responsive" />
					</div>
					<div data="2" class="col-md-2 img-small">
						<img id="product-image-2" src="${pageContext.request.contextPath}${product.image}2.jpg" class="img-responsive" />
					</div>
					<div data="3" class="col-md-2 img-small">
						<img id="product-image-3" src="${pageContext.request.contextPath}${product.image}3.jpg" class="img-responsive" />
					</div>
					<div data="4" class="col-md-2 img-small">
						<img id="product-image-4" src="${pageContext.request.contextPath}${product.image}4.jpg" class="img-responsive" />
					</div>
					<div data="5" class="col-md-2 img-small">
						<img id="product-image-5" src="${pageContext.request.contextPath}${product.image}5.jpg" class="img-responsive" />
					</div>
				</div>
				<div class="col-md-6">
					...
					<div class="col-md-12 price-bar">
						<small>学员售价：</small> ¥<span id="product-price">${product.price}</span>
					...
					<form class="form-inline product-form col-md-12" role="form">
						...
						<div class="col-md-12 form-space">
							<button id="btn-add-to-cart" type="button" class="btn go-cart btn-default "><span class="fa fa-cart-plus"></span> 加入购物车</button>
