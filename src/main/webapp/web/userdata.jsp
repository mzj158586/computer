            ...
            $.ajax({
                ...
                success:function (reg) {
                    if (reg.state==1){
                        ...
                        $("#username").val(reg.result.username)
                        $("#phone").val(reg.result.phone)
                        $("#email").val(reg.result.email)
                        var radio =reg.result.gender == 0 ? $("#gender-female") : $("#gender-male");
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<div><a href="web/userdata.jsp"><b>个人资料</b></a></div>
